...
super_matrix(
  x           = ds_catalog %>%
    dplyr::filter(wave_set %in% c(
      # "12345","1234","123"   # scenario 1
      # "12345","125"  ,"135" ,"145"   # scenario 2
      "12345","1235" ,"1245","1345"  # scenario 3
      )),
  model_type  = "aefb",
  process     = "mmse",
  folder_name = "./reports/wave-scenarios/scenario-3/",
  width       = 2800,
  height      = 2000,
  res         = 210
)
