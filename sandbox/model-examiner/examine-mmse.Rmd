...
output:
  html_document:
    css: ~/GitHub/ialsa-time-sensitivity/libs/css/sidebar-simple-wide.css
    highlight: kate
    keep_md: yes
    theme: flatly
    toc: yes
...
read_chunk("./reports/model-examiner/model-examiner.R") 
```
...
<!-- Basic graph view.   -->
```{r basic-graph, echo=TRUE, results='show', message=FALSE, fig.height=12,fig.width=16, output.width="1000px"}
```
