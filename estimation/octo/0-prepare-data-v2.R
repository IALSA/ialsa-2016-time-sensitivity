...
requireNamespace("haven") # for inputing SAV files
...
varnames_context <- c(
   "Female"    # Gender
  ,"CompAge1"  # composite age at baseline
  ,"Educyrs"   # Years of education
  ,"height1"   # Height in cantimeters at baseline
  ,"Smoke"     # Smoking
...
ds_wide <- ds %>%
  ...
  dplyr::select(
    Case,PairID,
    female,
    age_c80, edu_c7, sbp_c167
    ,smoke, cardio, diabetes,
